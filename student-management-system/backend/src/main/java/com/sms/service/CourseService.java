...
public class CourseService {
    ...
    public Attachment uploadAttachment(Long courseId, MultipartFile file) throws Exception {
        ...
        // 索引到Elasticsearch（异步处理，避免影响上传性能）
        try {
            byte[] fileData = file.getBytes();
            searchService.indexAttachment(savedAttachment, fileData);
        } catch (Exception e) {
            System.err.println("附件索引失败: " + e.getMessage());
        }
    ...
    public void deleteAttachment(Long attachmentId) throws Exception {
        ...
        // 删除ES索引
        try {
            searchService.deleteAttachmentIndex(attachmentId);
        } catch (Exception e) {
            System.err.println("删除附件索引失败: " + e.getMessage());
        }
